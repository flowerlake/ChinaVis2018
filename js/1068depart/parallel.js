...
$.get("data/groups/smallg/gfirst1068.json", function(legend_data) {
	$.get("data/groups/smallg/ggroup1068.json", function(groups) {
		$.get("data/parallel/tcp1068.json", function(data) {
			var schema = [{
					name: 'client_ip',
					index: 0,
					text: 'client_ip'
