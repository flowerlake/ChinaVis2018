...
$.get("data/groups/smallg/gfirst1059.json", function(legend_data) {
	$.get("data/groups/smallg/ggroup1059.json", function(groups) {
		$.get("data/parallel/tcp1059.json", function(data) {
			var schema = [{
					name: 'client_ip',
					index: 0,
					text: 'client_ip'
