...
if(myChartbart != null && myChartbart != "" && myChartbart != undefined) {
	myChartbart.dispose();
}
var myChartbart = echarts.init(document.getElementById("bart"),"dark");
